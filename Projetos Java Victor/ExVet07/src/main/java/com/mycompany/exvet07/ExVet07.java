    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < funcionarios; i++) {
            if (tempo[i] > 60) {
                ...
                System.out.println(" o trabalhador com aumento de 25% sera " + nome[i] + " com aumento de " + salario[i]);
            } else if (salario[i] < 1940) {
                salario[i] = salario[i] / 100 * 15;
                System.out.println("O trabalhador com aumento de 15% sera " + nome[i] + " com aumento de " + salario[i]);
            }else if (tempo[i] > 60 && salario[i] < 1940) {
                salario[i] = salario[i] / 100 * 35;
                System.out.println("o trabalhador com aumento de 35% sera " + nome[i] + " com aumento de " + salario[i]);
